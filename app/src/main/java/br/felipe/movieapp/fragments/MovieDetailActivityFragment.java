...
public class MovieDetailActivityFragment extends Fragment {
    ...
    private void setViews() {
        if(movie != null) {
            ...
            Picasso.with(getActivity()).load(Fetcher.BASE_POSTER_URL + movie.getPosterUrl()).placeholder(getActivity().getResources().getDrawable(R.mipmap.loading)).error(getActivity().getResources().getDrawable(R.mipmap.error)).into(moviePoster);
